(function(){
  ...
  var DETAIL = {
    ...
    order: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Order','--c-order'], bild:'i-p-order',
      ...
      intro:'QR-Bestell- und Kassensystem für Bars, Cafés und Lounges. Gäste scannen den Code am Tisch und bestellen selbst — ohne App-Installation, ohne Wartezeit am Tisch.',
  ...
  var BEITRAEGE = [
['12.06.2026','fach','Wem Ihre Kundendaten wirklich gehören','Datenschutz ist kein Formular, das man einmal ausfuellt. Er entscheidet, ob Sie beim Anbieterwechsel Ihre eigenen Kundendaten mitnehmen koennen — oder zuruecklassen muessen.','i-doku','<p>Die Datenschutz-Grundverordnung gilt vielen Betrieben als laestige Pflicht, die man mit einer Einwilligungserklaerung auf der Website abhakt. Das ist ein teurer Irrtum. Entscheidend ist nicht das Formular, sondern die Frage, wer die tatsaechliche Verfuegungsgewalt ueber Ihre Kundendaten hat — Sie oder Ihr Softwareanbieter.</p> <h3>Was Datenhoheit im Betriebsalltag bedeutet</h3> <p>Datenhoheit ist kein juristischer Begriff, sondern eine praktische Machtfrage. Wer Ihre Kundenstammdaten, Auftragshistorien und Rechnungen speichert, bestimmt am Ende die Bedingungen. Der samoLabs betreibt deshalb bewusst nach klaren Prinzipien:</p> <ul><li>Serverstandort ausschliesslich in Deutschland, keine Ausleitung in Rechtsraeume ohne angemessenes Schutzniveau.</li><li>Verschluesselte Speicherung und Uebertragung, getrennte Mandanten ohne gemeinsame Datentoepfe.</li><li>Klare Zugriffsrechte: Ihre Mitarbeiter sehen, was sie brauchen, nicht mehr.</li><li>Keine Weitergabe oder Zweitverwertung Ihrer Daten fuer Werbung oder das Training fremder Systeme.</li></ul> <h3>Der eine Test, den jeder Anbieter bestehen muss</h3> <p>Fragen Sie Ihren Softwareanbieter, wie Sie Ihre kompletten Daten wieder herausbekommen, wenn Sie kuendigen. Die Antwort verraet alles. Bei der samoLabs gehoeren Ihre Daten Ihnen: Sie erhalten auf Wunsch einen vollstaendigen, maschinenlesbaren Export Ihrer Kunden, Auftraege und Belege — ohne Aufpreis, ohne Wartezeit, ohne Klauseln im Kleingedruckten. Ein System, aus dem Sie nicht mehr herauskommen, ist kein Werkzeug, sondern eine Falle.</p> <h3>Datenschutz, der den Betrieb nicht ausbremst</h3> <p>Guter Datenschutz kostet keine Produktivitaet, wenn er von Anfang an eingebaut ist. Loeschfristen, Auskunftsersuchen und Protokollierung laufen im Hintergrund mit, statt jedes Mal manuelle Arbeit zu erzeugen. So erfuellen Sie Ihre Pflichten aus der DSGVO, ohne dass ein einziger Handgriff an der Werkbank oder am Tresen laenger dauert.</p>'],
['26.06.2026','fach','Aus einem Auftrag planbaren Umsatz machen','Ein repariertes Fahrrad ist kein abgeschlossener Vorgang, sondern der Beginn einer Kundenbeziehung. Wer die naechste Inspektion automatisch anstoesst, fuellt seine Werkstatt planbar.','i-kontakt','<p>Der haeufigste Umsatzverlust in Werkstaetten steht in keiner Bilanz: Es ist der Kunde, der nach der Reparatur geht und einfach nicht wiederkommt. Nicht aus Unzufriedenheit, sondern weil ihn niemand erinnert hat. Jeder abgeschlossene Auftrag, der nicht in einen naechsten muendet, ist verschenkte Kapazitaet.</p> <h3>Warum die Erinnerung den Unterschied macht</h3> <p>Ein Fahrrad braucht nach einigen Monaten die naechste Inspektion, die Bremsen wollen nachgestellt, die Schaltung neu justiert werden. Der Kunde weiss das selten. Der Betrieb weiss es genau — und hat mit jeder Reparatur die Datengrundlage, um den richtigen Zeitpunkt vorherzusagen. samoRad nutzt genau diese Historie: Aus dem Leistungsdatum und der Art der Arbeit entsteht automatisch der Anlass fuer die naechste Kontaktaufnahme.</p> <h3>Vom Hinweis zum gebuchten Termin</h3> <p>Eine Erinnerung allein bringt wenig, wenn der Kunde danach erst telefonieren muss. Deshalb enthaelt jede Service-Nachricht einen direkten Buchungslink. Der Kunde tippt auf einen freien Termin, und dieser landet ohne Zwischenschritt in Ihrem Werkstattkalender.</p> <ul><li>Automatischer Versand zum errechneten Wartungszeitpunkt, ohne dass jemand eine Liste pflegen muss.</li><li>Direkter Buchungslink statt Telefonschleife — der Kunde bucht, wann es ihm passt.</li><li>Auslastung der ruhigen Wochen, weil Termine vorgezogen statt verpasst werden.</li><li>Messbare Rueckkehrquote statt Bauchgefuehl.</li></ul> <h3>Aus Einmalgeschaeft wird planbarer Umsatz</h3> <p>Wer seine Kundschaft systematisch zurueckholt, verwandelt einen Stapel einzelner Auftraege in einen kalkulierbaren Grundstock an Auslastung. Das ist der Unterschied zwischen einer Werkstatt, die auf Laufkundschaft hofft, und einem Betrieb, der seine kommenden Wochen kennt.</p>'],
['10.07.2026','fach','Karten akzeptieren, ohne zur Bank zu muessen','Ein eigener Akzeptanzvertrag mit der Bank kostet Wochen und Grundgebuehren. Es geht auch anders: kontaktlos kassieren, Geld direkt aufs eigene Konto, ohne monatliche Fixkosten.','i-beleg','<p>Wer heute Karten akzeptieren will, landet schnell auf dem klassischen Weg: ein Akzeptanzvertrag mit der Bank, Bonitaetspruefung, Grundgebuehren und Wochen der Wartezeit, bevor die erste kontaktlose Zahlung durchlaeuft. Fuer viele Betriebe steht dieser Aufwand in keinem Verhaeltnis zum Nutzen — und sie kassieren weiter nur bar, obwohl laengst jeder Kunde die Karte zueckt.</p> <h3>Kartenakzeptanz ohne den Umweg ueber die Bank</h3> <p>Es geht einfacher. Ueber einen etablierten Zahlungsdienstleister — einen der groessten Zahlungsabwickler weltweit — akzeptieren Sie Karten- und Kontaktloszahlung direkt am Geraet, ohne selbst einen eigenen Akzeptanzvertrag abzuschliessen. Die technische und regulatorische Abwicklung uebernimmt der Dienstleister im Hintergrund. Sie kassieren, der Betrag landet auf Ihrem Konto.</p> <h3>Transparente Kosten statt Fixkostenfalle</h3> <p>Der entscheidende Unterschied liegt im Preismodell. Statt monatlicher Grundgebuehren, die auch in umsatzschwachen Wochen anfallen, zahlen Sie ausschliesslich pro Transaktion:</p> <ul><li>Transaktionsgebuehr von 1,89–2,89 %, ohne Grundgebuehr.</li><li>Keine Fixkosten, kein Mindestumsatz, kein Risiko in ruhigen Monaten.</li><li>Auszahlung direkt auf Ihr eigenes Konto.</li><li>Kontaktlos, Karte und mobile Bezahldienste ohne separate Zusatzhardware fuer jede Variante.</li></ul> <h3>Direkt in Ihre Ablaeufe eingebaut</h3> <p>Die Zahlung ist kein separates Terminal neben der Kasse, sondern Teil des Vorgangs. Ob der Kunde in der Werkstatt ueber samoRad abrechnet oder am Tisch ueber samoOrder bestellt — die Kartenzahlung schliesst den Beleg direkt ab, sauber dokumentiert und mit der zertifizierten TSE verbunden.</p>'],
['15.06.2026','fach','Ein Posteingang für alle Kanäle','Die meisten Betriebe verwalten Kundenkontakt nicht an einem Ort, sondern an fuenf. Warum WhatsApp, E-Mail, Formular und bald der Anruf in einen einzigen Vorgangs-Posteingang gehoeren.','i-chat','<p>WhatsApp auf dem Firmenhandy, das Kontaktformular im Mailpostfach, die Bewertungsantwort im Portal, der versprochene Rueckruf auf einem Notizzettel: Die meisten Betriebe steuern ihren Kundenkontakt nicht an einem Ort, sondern an fuenf. Jeder Kanal hat sein eigenes Postfach, seine eigene Zustaendigkeit und seine eigene Luecke, durch die eine Anfrage faellt.</p> <h3>Warum getrennte Postfaecher der eigentliche Fehler sind</h3> <p>Kanaele zu trennen bedeutet, Wissen zu trennen. Wer die E-Mail beantwortet, sieht die WhatsApp-Nachricht desselben Kunden von vorletzter Woche nicht. Es entsteht kein Bild vom Kunden, sondern ein Dutzend Fragmente, verteilt ueber Geraete, Personen und Apps.</p> <h3>Aus jeder Anfrage wird ein Vorgang</h3> <p>Der samoLabs dreht das Prinzip um. Nicht der Kanal ist die Einheit, sondern der Vorgang. Ob eine Nachricht ueber WhatsApp, E-Mail, das Formular oder demnaechst ueber den Anruf hereinkommt, samoChat legt sie als einen zuweisbaren Vorgang mit eindeutiger Nummer an, im selben Posteingang wie alles andere.</p> <ul><li>Eine Nummer, unter der die komplette Historie kanaluebergreifend zusammenlaeuft.</li><li>Eine klare Zustaendigkeit, sichtbar fuer das ganze Team statt versteckt auf einem Geraet.</li><li>Ein Status, der zeigt, ob offen, in Arbeit oder erledigt, ohne Rueckfrage im Flur.</li><li>Eine Antwort, die im selben Vorgang landet, egal ueber welchen Kanal der Kunde nachfasst.</li></ul> <h3>Was das im Alltag aendert</h3> <p>Nichts geht mehr im Verlauf verloren, weil es keinen Verlauf mehr gibt, den man durchscrollen muss. Ein Mitarbeiter, der uebernimmt, sieht sofort, was zugesagt wurde und was noch aussteht. Urlaub, Feierabend und Personalwechsel hoeren auf, Wissensluecken zu erzeugen.</p>'],
['03.07.2026','fach','Der Anruf, der nicht verloren geht','Ein besetzter Anschluss und eine Warteschleife sind kein Kundenkontakt, sondern sein Abbruch. Warum jeder Betrieb einen eigenen Erstkontakt am Telefon braucht, der einordnet und zurueckruft.','i-talk','<p>Ein Anruf ist der direkteste Weg, den ein Kunde waehlen kann, und fuer viele Betriebe der unzuverlaessigste Empfang. Es klingelt ins Leere, weil alle in der Werkstatt oder beim Kunden sind. Es landet in einer Mailbox, die niemand konsequent abhoert. Oder der Anrufer haengt in einer Warteschleife und legt nach neunzig Sekunden auf.</p> <h3>Warum die Warteschleife das teuerste Postfach ist</h3> <p>Ein verpasster Anruf hinterlaesst keine Spur. Keine Nummer, kein Anliegen, kein Name, den man zurueckrufen koennte. Anders als eine Nachricht, die liegen bleibt, verschwindet der Anruf vollstaendig. Genau deshalb braucht Telefonie keinen weiteren Anrufbeantworter, sondern einen echten Erstkontakt, der aufnimmt, was der Anrufer will, auch dann, wenn kein Mensch frei ist.</p> <h3>Der Sprachdialog als Erstkontakt</h3> <p>samoBot nimmt den Anruf entgegen, bevor er verloren geht. Er fragt in natuerlicher Sprache nach dem Anliegen, ordnet es ein und haelt Name und Rueckrufwunsch fest, statt den Anrufer in eine Schleife zu schicken.</p> <ul><li>Der Anrufer nennt sein Anliegen und wird eingeordnet, statt gegen ein Besetztzeichen zu sprechen.</li><li>Aus dem Gespraech wird ein Vorgang mit Nummer, Thema und Rueckrufwunsch, nicht ein vergessener Klingelton.</li><li>Was samoBot nicht abschliessend klaeren kann, uebergibt er sauber an einen Mitarbeiter, mit dem gesamten Kontext.</li></ul> <h3>Telefonie gehoert in denselben Posteingang</h3> <p>Der eigentliche Gewinn entsteht, weil der Anruf nicht in einem eigenen Silo landet. Er fliesst in samoChat in denselben Vorgangs-Posteingang wie WhatsApp, E-Mail und Formular. Ruft derselbe Kunde spaeter an, sieht Ihr Team seine offene Anfrage von gestern.</p>'],
['24.07.2026','fach','Wann sich Individualsoftware lohnt','Nicht jeder Betrieb braucht Software nach Mass, und nicht jeder ist mit Standard gut bedient. Eine ehrliche Einordnung, wann welche Wahl die richtige ist.','i-laptops','<p>Software nach Mass klingt nach der besseren Loesung, weil sie nach mehr klingt. Das ist ein schlechter Massstab. Die richtige Frage ist nicht, was aufwendiger ist, sondern was Ihre Ablaeufe am wenigsten verbiegt. Manchmal ist das ein Standardprodukt, das seit Jahren erprobt ist. Manchmal ist es eine Anwendung, die genau Ihren Betrieb abbildet und nichts sonst.</p> <h3>Wann Standardsoftware die richtige Wahl ist</h3> <p>Standard ist stark, wo ein Problem ueberall gleich aussieht. Buchhaltung, Lohn, klassische Warenwirtschaft folgen Regeln, die fuer den ganzen Markt gelten und die niemand fuer sich neu erfinden sollte. Wenn Ihre Ablaeufe zu einem bewaehrten Produkt passen, fahren Sie mit Standard schneller, guenstiger und ruhiger.</p> <h3>Wann sich der Bau nach Mass rechnet</h3> <p>Massarbeit lohnt sich dort, wo Ihr Ablauf der Grund ist, warum Kunden zu Ihnen kommen, und keine Standardloesung ihn ohne Verrenkung trifft. Die Anzeichen sind konkret:</p> <ul><li>Sie halten mehrere Programme mit Tabellen und Zuruf zusammen, weil kein Produkt Ihren Prozess ganz abdeckt.</li><li>Sie zahlen fuer Funktionsumfang, den Sie nie nutzen, und vermissen zugleich das eine, worauf es ankommt.</li><li>Ihr Wettbewerbsvorteil steckt genau in dem Ablauf, den die Software gerade behindert statt traegt.</li></ul> <h3>Der Unterschied, der bleibt: Betrieb</h3> <p>Eine Anwendung nach Mass ist nur so viel wert wie ihr laufender Betrieb. Der samoLabs baut nicht nur, sie betreibt. Hosting, Updates, Sicherheit und Weiterentwicklung bleiben in einer Hand, und die Software waechst mit Ihrem Betrieb, statt an dem Tag zu veralten, an dem sie fertig wird.</p>'],
