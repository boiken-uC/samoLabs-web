  ...
  var DETAIL = {
    ...
    order: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Order','--c-order'], bild:'i-p-order',
      ...
      punkte:[['Bestellen per Tisch-QR','Der Gast öffnet nur die Kamera, keine App, keine Anmeldung. Bestellt wird, sobald der Gast so weit ist.',
              ...
              ['Kasse nach KassenSichV','Die Anbindung an eine zertifizierte Sicherheitseinrichtung ist fertig und wird zum Start Ihres Betriebs scharfgeschaltet. DSFinV-K-Export und hash-verkettetes Archiv laufen bereits, Daten in Deutschland.',
              ...
              ['Getrennt zahlen ohne Rechnerei','Ein Tisch teilt sich in Runden. Positionen wandern einzeln in die passende Runde, jede zahlt für sich und bekommt ihren Beleg.', IC.verbindung]],
