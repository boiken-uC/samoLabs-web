  ...
  var DETAIL = {
    rad: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Rad','--c-rad'], bild:'i-annahme',
      ...
      punkte:[['Annahme am Tablet','Auftrag, Foto und Etikett in unter zwei Minuten, direkt am Tresen.'],
              ...
              ['Service-Erinnerungen','Die fällige Inspektion meldet sich von selbst — wiederkehrender Umsatz ohne Nachtelefonieren.'],
              ['Eigene App für die Werkstatt','Annahme, Werkstattbank und Ausgabe als native App, nicht nur im Browser.']],
