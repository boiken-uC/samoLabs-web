(function(){
  ...
  var PRODUKTE = [
    ...
    ['samo','Gold','--c-gold','i-beleg','Edelmetallhandel','Ankauf, Bestand in Gramm fein und Kasse für den Edelmetallhandel, mit Kundenakte nach Geldwäschegesetz.','gold'],
  ...
  var DETAIL = {
    ...
    gold: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Gold','--c-gold'], bild:'i-beleg',
      titel:'Ankauf, Bestand und Kasse für den Edelmetallhandel',
      intro:'Warenwirtschaft, Kundenakte und Kasse für Goldankauf und Edelmetallhandel. Das System rechnet in Gramm fein, führt die Akte nach Geldwäschegesetz und bestimmt die Besteuerung je Vorgang.',
      h2:'Vom Tresen bis zum Tagesabschluss',
      text:'Der Kunde legt Schmuck, Barren oder Münzen auf den Tresen. Die Kasse rechnet aus Gewicht und Feingehalt den Ankaufspreis, prüft vorab, ob eine Identifizierung nötig ist, und bucht Ankauf, Bestand und Beleg in einem Schritt. Was später verkauft wird, trägt seinen Einstand mit. So steht am Ende fest, was Marge war und wie sie zu versteuern ist.',
      punkte:[['Rechnet in Gramm fein','Ein 585er Ring mit 4,2 Gramm enthält 2,457 Gramm Feingold. Bestand und Bewertung laufen im Feingewicht, nicht in Stück.', IC.lineal],
              ['Ausweispflicht erkannt, bevor der Preis fällt','Ab 2.000 Euro in bar greift das Geldwäschegesetz, auch wenn mehrere kleine Ankäufe zusammengehören. Das System rechnet 30 Tage zurück und sagt, warum.', IC.schild],
              ['Ausweisdaten verschlüsselt','Die Ausweisdaten liegen verschlüsselt, jeder Zugriff wird protokolliert. Nach Ablauf der Frist meldet das System die fällige Löschung.', IC.schloss],
              ['Differenzbesteuerung je Vorgang','Besteuert wird die Marge statt des Umsatzes, wo das Gesetz es vorsieht. Anlagegold läuft steuerfrei. Der Einstand steht an jeder Bewegung.', IC.beleg],
              ['Ankaufspreise mit Freigabe','Der Kurs darf sich bewegen. Öffentlich wird ein Preis erst, wenn ihn jemand freigibt.', IC.diagramm],
              ['Unterschrift am Kundenpad','Ein zweites Tablett am Tresen zeigt dem Kunden seinen Ankauf. Er unterschreibt direkt darauf.', IC.stift],
              ['Gebuchtes bleibt gebucht','Belege sind nach dem Buchen gesperrt. Ein Fehler wird gegengebucht, der ursprüngliche Beleg bleibt stehen.', IC.vorgang],
              ['Bestand, der stimmt','Kein Zählerstand, der abweichen kann: Der Bestand ist immer die Summe seiner Belege.', IC.speicher]],
      alltag:[['Kein Kopfrechnen am Tresen','Feingehalt, Kurs und Abschlag stehen im Beleg, bevor der Kunde fragt.'],
              ['Keine Lücke in der Akte','Wer identifiziert werden muss, wird es. Ohne gültigen Ausweis bucht die Kasse den Barankauf über der Schwelle nicht.'],
              ['Weniger Nacharbeit für die Steuerberatung','Marge und Steuerart stehen je Vorgang fest, nicht erst am Jahresende.'],
              ['Der Bestand passt zum Tresor','Feingold, Silber, Zinn und versilbertes Besteck auf eigenen Warenkonten, jeweils in Gramm.'],
              ['Nachvollziehbar bis zum Einzelstück','Jede Bewegung trägt Datum, Beleg und Einstand. Auch ein Jahr später.'],
              ['Zugriff nur für die Richtigen','Rolle und Status werden bei jeder Anfrage frisch geprüft. Eine Sperre wirkt sofort.']], bloecke:[['Die Akte, die der Händler ohnehin führen muss','Goldankauf ist Güterhandel im Sinne des Geldwäschegesetzes. Ab 2.000 Euro in bar muss der Kunde identifiziert werden, und die Unterlagen bleiben fünf Jahre. Viele Kassen erfassen den Ausweis, rechnen aber nicht zusammen: Drei Ankäufe über je 900 Euro am selben Tag laufen dort durch. samoGold rechnet das Fenster mit, meldet die Pflicht vor der Preisnennung und nennt den Grund im Klartext, damit der Mitarbeiter versteht, warum er fragen muss.','i-formular'],['Gewicht in Milligramm, Geld in Cent','Wer mit Kommazahlen rechnet, verliert über Tausende Buchungen Gramm und Euro, ohne dass es jemand merkt. samoGold rechnet durchgehend in ganzen Milligramm und Cent. Der Bestand ist die Summe gerundeter Einzelposten, nie eine gerundete Summe. Eine Eingabe wie 1.234,50 Gramm weist das System zurück, statt sie still falsch zu lesen.','i-papier'],['Am Tresen gebaut, nicht am Schreibtisch','samoGold entsteht zusammen mit einem Edelmetallhändler im laufenden Betrieb. Kasse und Kundenpad sind Android-Tabletts, die Verwaltung läuft im Browser. Die Oberfläche trägt das Erscheinungsbild des Händlers, nicht unseres.','i-doku']], fragen:[['Für wen ist samoGold gedacht?','Für Goldankauf, Edelmetallhandel und Juweliere mit Ankauf. Überall dort, wo nach Gewicht und Feingehalt eingekauft wird.'],['Welche Geräte brauchen wir?','Ein Android-Tablett als Kasse, auf Wunsch ein zweites als Kundenpad für die Unterschrift. Die Verwaltung läuft im Browser.'],['Was passiert mit den Ausweisdaten?','Sie liegen verschlüsselt und getrennt vom übrigen Bestand. Jeder Blick darauf wird protokolliert, und nach Ablauf der Aufbewahrungsfrist meldet das System die Löschung.']]},
...
.catch(function(){ halter.style.display = 'none'; });
  ...
  var R=[
    ...
    [['gold','silber','edelmetall','ankauf','juwelier'],'Dafür gibt es samoGold: Ankauf nach Gewicht und Feingehalt, Bestand in Gramm fein und die Kundenakte nach Geldwäschegesetz. Kaufen Sie vor allem Altgold an oder auch Barren und Münzen?'],
