(function(){
  ...
  var PRODUKTE = [
    ['samo','Rad','--c-rad','i-werk','Fahrradfachhandel','Werkstatt, Kasse und Warenwirtschaft mit eigener App für Tresen und Werkstatt.','rad'],
    ['samo','Order','--c-order','i-gastro','Gastronomie','QR-Bestellsystem für Bars, Cafés und Lounges — vom Tisch direkt an die Theke.','order'],
    ['samo','Transport','--c-transport','i-trans','Logistik','Frachtbörse mit Tourenplanung und Sendungsverfolgung für Speditionen und Fahrer.','transport'],
    ...
    ['samo','Plan','--c-plan','i-team','Gebäudetechnik','Aufmaß und Projektplanung für Betriebe der technischen Gebäudeausrüstung.','plan'],
  ...
  var DETAIL = {
    rad: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Rad','--c-rad'], bild:'i-werk',
      ...
      alltag:[['Der Kunde ruft nicht mehr an','Die Nachricht, dass das Rad fertig ist, geht automatisch raus.'],
              ['Niemand sucht mehr Zettel','Jedes Rad trägt ein Etikett mit Nummer, jeder Vorgang eine Historie.'],
              ['Der Abend wird kürzer','Tagesabschluss und Kassenbericht entstehen nebenbei.']] },

    order: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Order','--c-order'], bild:'i-gastro',
      ...
      text:'Der Gast scannt den Code an seinem Tisch und sieht die aktuelle Karte. Was er bestellt, erscheint in Echtzeit auf dem Terminal hinter der Theke — mit Tischnummer, ohne Zwischenruf und ohne Zettel, der verloren geht.',
    ...
    transport: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Transport','--c-transport'], bild:'i-trans',
    ...
    vertrieb: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Vertrieb','--c-vertrieb'], bild:'i-talk',
      ...
      punkte:[['Besuchsplanung','Wer wird wann besucht, wer ist überfällig — auf einen Blick.'],
              ...
              ['Bericht per Sprache','Diktieren statt tippen. Fertig, bevor der Motor aus ist.'],
    ...
    plan: { ober:'Produkte', oberZiel:'produkte', marke:['samo','Plan','--c-plan'], bild:'i-team',
    ...
    werkstatt: { ober:'Lösungen', oberZiel:'loesungen', bild:'i-werk',
      ...
      alltag:[['Kunden fragen seltener nach','Weil sie automatisch erfahren, wenn etwas fertig ist.'],
              ...
              ['Der Abend endet früher','Der Kassenabschluss entsteht nebenbei.']] },

    gastro: { ober:'Lösungen', oberZiel:'loesungen', bild:'i-gastro',
      titel:'Gastronomie',
      intro:'Bestellung am Tisch per QR-Code, Übersicht an der Theke, Abrechnung ohne Zettelwirtschaft.',
    ...
    auswertung: { ober:'Lösungen', oberZiel:'loesungen', bild:'i-team',
      ...
      alltag:[['Kein Monatsende-Stress','Die Zahlen liegen schon vor.'],
  ...
  var BEITRAEGE = [
    ...
    ['20 / 11 / 2025','produkt','Berichte diktieren statt tippen','Zwei gesprochene Sätze werden zum strukturierten Besuchsbericht. Fertig, bevor der Motor aus ist.','i-talk'],
